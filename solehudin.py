buatlah kodingan agar grafik memiliki warna yang berbeda pada kodingan di bawah ini
...
plt.hist(df['Usia'], bins=10, edgecolor='black')
...
plt.figure(figsize=(10, 6))
df['Kota'].value_counts().plot(kind='bar', color='skyblue', edgecolor='black')
